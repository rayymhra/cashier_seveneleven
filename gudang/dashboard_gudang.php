...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-page">
            ...
            <a href="dashboard_gudang.php?page=kelola_barang"><i class="bi bi-box-seam me-2"></i>Kelola Barang</a>
            <a href="dashboard_gudang.php?page=kelola_supplier"><i class="bi bi-truck me-2"></i>Kelola Supplier</a>
        </div>
